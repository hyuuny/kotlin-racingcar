...
const val NULL_ERROR_MSG = " 이름은 5글자이하여야 합나다."
const val EMPTY_ERROR_MSG = " 이름은 공백일 수 없습니다."

internal class NameTest {

    @Test
    internal fun `이름 null 예외`() {
        shouldThrow<IllegalArgumentException> {
            Name(null)
        }.shouldHaveMessage(ERROR_MSG + NULL_ERROR_MSG)
    }

    @Test
    internal fun `이름 Empty 예외`() {
        shouldThrow<IllegalArgumentException> {
            Name(" ")
